...
class EmbeddingConfig(_ConfigBase):
    ...
    model_engine: str = Field(
        ...
        description="Engine/provider for embedding generation (e.g., nvidia-ai-endpoints, huggingface, tei, openai-compatible)",
    )
...
class RankingConfig(_ConfigBase):
    ...
    model_engine: str = Field(
        ...
        description="Engine/provider for reranking service (e.g., nvidia-ai-endpoints, tei)",
    )
    server_url: str = Field(
        default="",
...
class SummarizerConfig(_ConfigBase):
    ...
    model_engine: str = Field(
        default="nvidia-ai-endpoints",
        env="APP_SUMMARY_MODELENGINE",
        description="Engine/provider for summarizer (e.g., nvidia-ai-endpoints, openai, vllm, openai-compatible)",
    )
